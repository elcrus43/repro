 ...
 * ������������� ������� ���� ����� AI Vision.
 * ��������� base64-������ PDF ��� �����������, ���������� ����������������� ���� ����.
 * Gemini ������������ PDF ������� (application/pdf inline_data).
 */
async function handleScanEgrn(fileBase64, mimeType) {
  const EGRN_PROMPT = `�� � ������ OCR-��������� ��� ���������� ������� �� ���� (������ ��������������� ������ ������������).
����������� �������� ���� �������� � ����� ������ JSON ��� ������� ������, ������������ � markdown-������.
...
���� ���� �� ������� � ����� null ��� ������ ������. ����� ������ JSON.`;
  ...
  // 1. Gemini Vision � ������������ PDF ������� (application/pdf inline_data)
  if (GEMINI_API_KEY) {
  ...
  throw lastError || new Error('��� vision-������ ���������� ��� �� ����������������.');
}
