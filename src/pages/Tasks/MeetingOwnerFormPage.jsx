...
import { Calendar, User, Home, UserPlus, X } from 'lucide-react';
    ...
    return (
        <div className="page fade-in">
            <div className="topbar">
                ...
                <span className="topbar-title">{editId ? 'Редактировать' : 'Встреча с собственником'}</span>
            </div>
            <div className="page-content">
                <form onSubmit={handleSubmit} className="card" style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                    ...
                    {/* Объект (опционально) */}
                    <div className="form-group">
                        <label className="form-label"><Home size={14} style={{ marginRight: 4 }} /> Объект</label>
                        <select className="form-select" value={form.property_id || ''} onChange={e => setF('property_id', e.target.value)}>
                    ...
                    <div className="form-group">
                        ...
                        <textarea className="form-textarea" rows={3} value={form.description || ''} onChange={e => setF('description', e.target.value)} placeholder="Тема встречи, что обсудить..." />
                    </div>
                    ...
                    <button type="submit" className="btn btn-primary btn-full" style={{ marginTop: 8 }}>
                        ...
                        {editId ? 'Сохранить изменения' : 'Запланировать встречу'}
                    </button>
                </form>
            </div>
        </div>
