                        ...
                        <div key={req.id} className="card card-clickable" onClick={() => navigate(`/requests/${req.id}`)}>
                            <div className="flex items-start gap-8" style={{ marginBottom: 8 }}>
                                ...
                                <div style={{ flex: 1 }}>
                                    ...
                                    {client ? (
                                        <div style={{ fontSize: 12, color: '#2563EB', fontWeight: 600 }}>{formatPhone(client.phone)}</div>
                                    ) : (
                        ...
                        <div style={{ flex: 1 }}>
                            ...
                            {client ? (
                                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                                    <a href={`tel:${client.phone}`} style={{ fontSize: 13, color: '#2563EB', fontWeight: 700 }} onClick={e => e.stopPropagation()}>{formatPhone(client.phone)}</a>
