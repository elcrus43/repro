...
export function FormPage() {
    ...
    return (
        <div className="page fade-in" style={{ paddingBottom: 120 }}>
            ...
            <form className="page-content" style={{ padding: '20px', display: 'flex', flexDirection: 'column', gap: 16 }} onSubmit={handleSubmit}>
                ...
                <div className="card" style={{ padding: '24px', border: 'none', boxShadow: '0 8px 32px rgba(0,0,0,0.03)', borderRadius: 32, background: showPassport ? 'white' : 'var(--bg-light)', transition: 'all 0.3s' }}>
                    ...
                    >
                        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                            ...
                            <span className="font-oswald" style={{ fontWeight: 700, fontSize: 16, textTransform: 'uppercase', letterSpacing: '0.05em' }}>Паспортные данные</span>
                        </div>
                ...
                <div style={{ 
                    ...
                    borderTop: '1px solid rgba(0,0,0,0.05)', zIndex: 100
                }}>
                    <button type="submit" className="btn btn-primary btn-full" style={{ height: 56, borderRadius: 18, fontSize: 16, textTransform: 'uppercase', letterSpacing: '0.05em' }}>{id ? 'Сохранить изменения' : 'Создать клиента'}</button>
                </div>
            </form>
        </div>
    );
