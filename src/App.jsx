...
const ClientCardPage = lazy(() => import('./pages/Clients').then(m => ({ default: m.ClientCardPage })));
const ClientFormPage = lazy(() => import('./pages/Clients').then(m => ({ default: m.ClientFormPage })));
const PropertiesPage = lazy(() => import('./pages/Properties'));
const PropertyCardPage = lazy(() => import('./pages/Properties').then(m => ({ default: m.PropertyCardPage })));
const PropertyFormPage = lazy(() => import('./pages/Properties').then(m => ({ default: m.PropertyFormPage })));
const PublicPropertyPage = lazy(() => import('./pages/Properties').then(m => ({ default: m.PublicPropertyPage })));
const RequestsPage = lazy(() => import('./pages/Requests'));
const RequestCardPage = lazy(() => import('./pages/Requests').then(m => ({ default: m.RequestCardPage })));
const RequestFormPage = lazy(() => import('./pages/Requests').then(m => ({ default: m.RequestFormPage })));
...
const ShowingsPage = lazy(() => import('./pages/Showings'));
const ShowFormPage = lazy(() => import('./pages/Showings').then(m => ({ default: m.ShowFormPage })));
const ShowDetailsPage = lazy(() => import('./pages/Showings').then(m => ({ default: m.ShowDetailsPage })));
