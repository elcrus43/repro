...
CREATE TABLE IF NOT EXISTS properties (
  ...
  house_has_cadastre       BOOLEAN DEFAULT FALSE,
  house_cadastral_number   TEXT,
  has_electricity          BOOLEAN DEFAULT FALSE,
  electricity_kw           NUMERIC,
  ...
  garage_area              NUMERIC,
  has_gazebo               BOOLEAN DEFAULT FALSE,
  has_greenhouse           BOOLEAN DEFAULT FALSE,
  has_well                 BOOLEAN DEFAULT FALSE,
  has_summer_kitchen       BOOLEAN DEFAULT FALSE,
