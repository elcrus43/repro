/**
 * Скрипт для применения миграции 040 в Supabase
 */
...
async function runMigration() {
  console.log('🚀 Применяю миграцию 040...');

  const sqlPath = './supabase/migrations/040_add_deal_expenses.sql';
